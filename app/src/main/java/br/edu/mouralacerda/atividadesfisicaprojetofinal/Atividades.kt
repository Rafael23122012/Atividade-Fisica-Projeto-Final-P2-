package br.edu.mouralacerda.atividadesfisicaprojetofinal
...
import br.edu.mouralacerda.atividadesfisicaprojetofinal.entity.Movimento
import br.edu.mouralacerda.atividadesfisicaprojetofinal.entity.createGpxDocument
...
class Atividades : AppCompatActivity(), SensorEventListener, LocationListener {
    ...
    fun stopActivity() {
        ...
        val gpxContent: String = createGpxDocument(movimentos)
        println(gpxContent)
    }
